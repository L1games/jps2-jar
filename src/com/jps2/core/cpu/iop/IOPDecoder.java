...
public class IOPDecoder {
	...
	private static final Instruction	opcodeTable[]	= {
						...
						IOPInstructions.BEQ,
						IOPInstructions.BNE,
						IOPInstructions.BLEZ,
						IOPInstructions.BGTZ,
						IOPInstructions.ADDI,
						IOPInstructions.ADDIU,
						IOPInstructions.SLTI,
						IOPInstructions.SLTIU,
						IOPInstructions.ANDI,
						IOPInstructions.ORI,
						IOPInstructions.XORI,
						IOPInstructions.LUI,
						new STUB() {
							@Override
							public Instruction instance(final int insn) {
	...
	private static final Instruction	specialTable[]	= {
						...
						IOPInstructions.SRL,
						IOPInstructions.SRA,
						IOPInstructions.SLLV,
						Common.UNK,
						IOPInstructions.SRLV,
						IOPInstructions.SRAV,
						IOPInstructions.JR,
						IOPInstructions.JALR,
						Common.UNK,
						Common.UNK,
						IOPInstructions.SYSCALL,
						IOPInstructions.BREAK,
						Common.UNK,
						Common.UNK,
						IOPInstructions.MFHI,
						IOPInstructions.MTHI,
						IOPInstructions.MFLO,
						IOPInstructions.MTLO,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						IOPInstructions.MULT,
						IOPInstructions.MULTU,
						IOPInstructions.DIV,
						IOPInstructions.DIVU,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						IOPInstructions.ADD,
						IOPInstructions.ADDU,
						IOPInstructions.SUB,
						IOPInstructions.SUBU,
						IOPInstructions.AND,
						IOPInstructions.OR,
						IOPInstructions.XOR,
						IOPInstructions.NOR,
	...
	private static final Instruction	regimmTable[]	= {
						IOPInstructions.BLTZ,
						IOPInstructions.BGEZ,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						...
						Common.UNK,
						Common.UNK,
						IOPInstructions.BLTZAL,
						IOPInstructions.BGEZAL,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						Common.UNK,
	...
	private static final Instruction	cpo0Table[]		= {
						IOPInstructions.MFC0,
						Common.UNK,
						IOPInstructions.CFC0,
						Common.UNK,
						IOPInstructions.MTC0,
						Common.UNK,
						IOPInstructions.CTC0,
						Common.UNK,
						Common.UNK,
						Common.UNK,
						Common.UNK,
