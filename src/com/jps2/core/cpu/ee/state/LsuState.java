...
public abstract class LsuState extends MduState {
	...
	private static final long[]	ldrMask		= new long[] {
						0x0000000000000000L,
						0xff00000000000000L,
						0xffff000000000000L,
						0xffffff0000000000L,
	...
	private static final int[]	ldrShift	= new int[] {
						0,
						8,
						16,
						24,
	...
	public void doLDR(final int rt, final int rs, final int simm16) {
		...
		if (rt != 0) {
			gpr[rt].write64((data >>> ldrShift[offset]) | (gpr[rt].read64() & ldrMask[offset]));
		}
	}

	private static final long[]	ldlMask		= new long[] {
						0x00ffffffffffffffL,
						0x0000ffffffffffffL,
						0x000000ffffffffffL,
						0x00000000ffffffffL,
	...
	private static final int[]	ldlShift	= new int[] {
						56,
						48,
						40,
						32,
	...
	public void doLDL(final int rt, final int rs, final int simm16) {
		...
		if (rt != 0) {
			gpr[rt].write64((gpr[rt].read64() & ldlMask[offset]) | (data << ldlShift[offset]));
		}
	}
	...
	private static final long[]	sdlMask		= {
						0xffffffffffffff00L,
						0xffffffffffff0000L,
						0xffffffffff000000L,
						0xffffffff00000000L,
	...
	private static final int[]	sdlShift	= {
						56,
						48,
						40,
						32,
	...
	private static final long[]	sdrMask		= {
						0x0000000000000000L,
						0x00000000000000ffL,
						0x000000000000ffffL,
						0x0000000000ffffffL,
	...
	private static final int[]	sdrShift	= {
						0,
						8,
						16,
						24,
