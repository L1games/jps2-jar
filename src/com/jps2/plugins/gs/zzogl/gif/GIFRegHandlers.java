...
public final class GIFRegHandlers {
	...
	public static final GIFRegHandler	PACKED_RGBA		= new GIFRegHandler("PACKED_RGBA") {
															@Override
	...
	public static final GIFRegHandler	PACKED_STQ		= new GIFRegHandler("PACKED_STQ") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {
	...
	public static final GIFRegHandler	PACKED_XYZF2	= new GIFRegHandler("PACKED_XYZF2") {
															@Override
	...
	public static final GIFRegHandler	PACKED_XYZ2		= new GIFRegHandler("PACKED_XYZ2") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {// TODO
																// -
																// make
	...
	public static final GIFRegHandler	PACKED_FOG		= new GIFRegHandler("PACKED_FOG") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {
																gs.vertexregs.f = (short) ((data[3] & 0xff0) >> 4);
															}
														};
	public static final GIFRegHandler	PACKED_NULL		= new GIFRegHandler("PACKED_NULL") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {// TODO
																// -
																// make
	...
	public static final GIFRegHandler	PACKED_A_D		= new GIFRegHandler("PACKED_A_D") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {
																if ((data[2] & 0xff) < 100) {
																	GIFDecoder.handlerReg(gs, data[2] & 0xff, data);
																} else {
																	NULL.handler(gs, data);
																}
															}
														};
	public static final GIFRegHandler	PACKED_NOP		= new GIFRegHandler("PACKED_NOP") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {
																// Nothing to do
															}
	...
	public static final GIFRegHandler	XYOFFSET_1		= new GIFRegHandler("XYOFFSET_1") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {// TODO
																// -
																// make
	...
	public static final GIFRegHandler	XYOFFSET_2		= new GIFRegHandler("XYOFFSET_2") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {// TODO
																// -
																// make
	...
	public static final GIFRegHandler	PRMODECONT		= new GIFRegHandler("PRMODECONT") {
															@Override
															public void handler(final GSInternal gs, final int[] data) {// TODO
																// -
																// make
